...
export const SettingsWindowRef = () => {
    ...
    const handleSaveChanges = () => {
        localStorage.setItem("newNotifications__ref", isNewNotifications.toString());
        localStorage.setItem("acceptedNotifications__ref", isAcceptedNotifications.toString());
    ...
    useEffect(() => {
        const newNotificationsValue = localStorage.getItem("newNotifications__ref");
        const acceptedNotificationsValue = localStorage.getItem("acceptedNotifications__ref");
